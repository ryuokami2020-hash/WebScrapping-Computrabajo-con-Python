...
| Ubicación  | Ciudad o región donde se ofrece el trabajo |
| Salario    | Remuneración ofrecida (si está disponible) |
...
```bash
git clone https://github.com/ryuokami2020-hash/WebScrapping-Computrabajo-con-Python.git
...
1. Abrirá Google Chrome y accederá a Computrabajo
2. Recopilará los enlaces de todas las ofertas disponibles en la página
3. Ingresará a cada oferta y extraerá título, empresa, ubicación y salario
4. Guardará toda la información en el archivo `ListaTrabajo.csv`
